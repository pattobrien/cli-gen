...
- fix: Generated `userMethod` fields inherit returnType from the user-defined
  method.
...
- feat: Override the generated command name, description, or category via any
  command annotation (`@cliCommand`, `@cliRunner`, `@cliSubcommand`)
